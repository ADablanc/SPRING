...
RcppExport SEXP _SPRING_align_spectras(SEXP q_spectraSEXP, SEXP l_spectrasSEXP, SEXP min_deviation_mzSEXP, SEXP min_deviation_abdSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_SPRING_align_spectras", (DL_FUNC) &_SPRING_align_spectras, 4},
    {NULL, NULL, 0}
};
